...
public class Knight1 : MonoBehaviour
{
    ...
    static public int column = 2;
    static public int row = 0;
    static public int column2 = 2;
    ...
    {
        Enemy1.stalker_1_column = column;
        Enemy1.stalker_1_row = row;
        Knight5.stalker_1_column = column;
        Knight5.stalker_1_row = row;
        Knight4.stalker_1_column = column;
        Knight4.stalker_1_row = row;
        ESerf1.stalker_1_column = column;
        ESerf1.stalker_1_row = row;
        ESerf2.stalker_1_column = column;
        ESerf2.stalker_1_row = row;
    }
   public void Neighbours()
    ...
    public void Ult()
    {
        FindObjectOfType<Controller>().RangeOfUltStalker(column, row, id);

    }

    public void Attack()
    {
        FindObjectOfType<Controller>().RangeOfAttackStalker(column, row, dmg , id);
    }
    ...
    public void Death()
    {
        ...
        if (currentHealth <= 0)
        {
            ...
            IsDead.dead_units = IsDead.dead_units + 1;
    ...
    public IEnumerator AnimationUlt(int rotation)
    {
        ...
        Debug.Log(" blokada ? " + ButtonUlt.blockade + ButtonUlt.blockade2 + ButtonAttack.blockade + ButtonAttack.blockade2);
    ...
    public IEnumerator Animation(int rotation)
    {
        ...
        if (rotation ==1)
        {
        ...
        else if (rotation == 2)
            {
                animator.SetTrigger("idle");
                yield return new WaitForSeconds(0.01f);
          //  transform.Translate(new Vector3(0.6f, -1f, 0f).normalized * 0.6f);
