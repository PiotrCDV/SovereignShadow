...
public class ESerf2 : MonoBehaviour
{
    ...
    public void Death()
    {
        if (currentHealth <= 0)
        {
            ...
            IsDead.dead_units = IsDead.dead_units + 9;
    ...
    public void EnemyTurn()
    {
        ...
        if (knight_2_row != 100 && find == false && taunt != 1 && taunt != 4)
        {
                ...
                idCelu = 3;
                Debug.Log("heheheh no jestem o tu");
            ...
            {
                    Debug.Log("heheheh no jestem o tu1");
            ...
            {
                    Debug.Log("heheheh no jestem o tu2");
            ...
            {
                    Debug.Log("heheheh no jestem o tu3");
            ...
            {
                    Debug.Log("heheheh no jestem o tu4");
            ...
            {
                    Debug.Log("heheheh no jestem o tu5");
                ...
                {
                    Debug.Log("heheheh no jestem o tu6 " + taunt + "  " + find + "  " + knight_1_row);
        ...
        if (knight_1_row != 100 && find == false && taunt != 2 && taunt != 4)
        {
                ...
                idCelu = 2;
                Debug.Log("heheheh no jestem o tu7");
                ...
                || row == knight_1_row && column == knight_1_column + 1 || row == knight_1_row && column == knight_1_column - 1)
            {
                ...
                find = true;
                    taunt = 0;
                    Debug.Log("heheheh no jestem o tu8");
                ...
                else if (row > knight_1_row && Controller.pole[2] == '0')
            {
                ...
                find = true;
                    taunt = 0;
                    Debug.Log("heheheh no jestem o tu9");
                ...
                else if (column > knight_1_column && Controller.pole[3] == '0')
            {
                ...
                find = true;
                    taunt = 0;
                    Debug.Log("heheheh no jestem o tu10");
                ...
                else if (Controller.pole[1] == '0')
            {
                ...
                find = true;
                    taunt = 0;
                    Debug.Log("heheheh no jestem o tu11");
    ...
    public IEnumerator Movement()
    {
        ...
        else
        {
            ...
            Debug.Log(Controller.ende + " dlaczegoooo");
