...
public class Serf1 : MonoBehaviour
{
    float z = (float)-3.9499;
    bool firstMove = false;
    static public int column = 5;
    static public int row = 1;
    static public int column2 = 5;
    ...
    {
        Enemy1.serf_1_column = column;
        Enemy1.serf_1_row = row;
        Knight5.serf_1_column = column;
        Knight5.serf_1_row = row;
        Knight4.serf_1_column = column;
        Knight4.serf_1_row = row;
        ESerf1.serf_1_column = column;
        ESerf1.serf_1_row = row;
        ESerf2.serf_1_column = column;
        ESerf2.serf_1_row = row;
    }
    ...
    public void Death()
    {
        if (currentHealth <= 0)
        {
            ...
            IsDead.dead_units = IsDead.dead_units + 0;
